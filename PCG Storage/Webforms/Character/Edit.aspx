<%@ Page Title="" Language="C#" MasterPageFile="~/Default.Master" AutoEventWireup="true" CodeBehind="Edit.aspx.cs" Inherits="Pcg_Storage.Webforms.Character.Edit" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <fieldset>
        <legend>Cards</legend>
        <div>Favored card type: <asp:Literal ID="literalFavoredCardType" runat="server"></asp:Literal></div><hr />
        <div>
